...
export const metadata: Metadata = {
  ...
  description: 'Купи дамски бански, мъжки шорти за плаж, детски купальници в България. Дамска плажна облекла: панталони, поли, шорти, халати, шалове. Tan-through технология, UV защита SPF 35+. Доставка с Еконт!',
  keywords: [
  ...
  openGraph: {
    ...
    url: '/',
    title: 'RoDaSoleil България - Дамски и Мъжки Бански | Купи Купальници Онлайн',
    description: 'Премиум дамски бански с tan-through технология. Дамска плажна облекла: панталони, поли, шорти, халати. Мъжки и детски купальници. Доставка с Еконт в България!',
  ...
  twitter: {
    ...
    description: 'Премиум дамски бански и плажна облекла с tan-through технология. Доставка с Еконт!',
    images: ['/og-image.jpg'],
