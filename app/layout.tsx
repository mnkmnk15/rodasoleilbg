...
export const metadata: Metadata = {
  ...
  metadataBase: new URL(process.env.NEXT_PUBLIC_SITE_URL || 'https://www.rodasoleil.bg'),
  alternates: {
    canonical: 'https://www.rodasoleil.bg/bg',
    languages: {
      'bg': 'https://www.rodasoleil.bg/bg',
      'ru': 'https://www.rodasoleil.bg/ru',
      'en': 'https://www.rodasoleil.bg/en',
    },
  },
  openGraph: {
    type: 'website',
    ...
    url: 'https://www.rodasoleil.bg/bg',
    ...
    images: [
      {
        url: 'https://www.rodasoleil.bg/images/category-women.webp',
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://www.rodasoleil.bg/images/category-women.webp'],
    creator: '@rodasoleil',
  },
  robots: {
    index: true,
