          ...
          <div className="space-y-8 font-raleway" style={{ color: '#2A2422' }}>
            ...
            <section>
              ...
              <div className="space-y-3 leading-relaxed" style={{ opacity: 0.85 }}>
                ...
                <p>
                  Цената за доставка се определя в зависимост от избрания метод: до офис на Еконт - 3€, до адрес - 3.50€, безплатно самовземане в Бургас. Цената се посочва преди финализиране на поръчката.
                </p>
                <p>
